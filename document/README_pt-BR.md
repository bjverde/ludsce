...
1. Baixar o [Adianti Fork Temaplate 8.0.0.1](https://github.com/bjverde/adianti-fork-template/releases/tag/v8.0.0.1) copiar o conteúdo do template na pasta `ludsce\system\admin`. *As pastas podem ser mescaladas. Porém NÃO PODE SUBSTITUIR qualquer arquivo*.
